...
const AudioCallRouter = require("./routes/AudioCall");
const VideoCallRouter = require("./routes/VideoCall");
const MemoVocalRouter = require("./routes/MemoVocale");
...
const db = (module.exports = () => {
  try {
    ...
    app.use("/audiocalls", jsonParser, AudioCallRouter);

    app.use("/videocalls", jsonParser, VideoCallRouter);

    app.use("/memovocale", jsonParser, MemoVocalRouter);

    app.use("/image", jsonParser, ImageRouter);

    app.use("/fichier", jsonParser, FichierRouter);
    //app.use("/", jsonParser, AudioCallRouter);
